<template xmlns:style="http://www.w3.org/1999/xhtml">
  <div flex="dir:top main:left cross:center " style="width:100%; height: 55rem; ">
    ...
    <div style="width:85%; height: 28rem; margin-top: 0.5rem; background: white;opacity: 1;" >
      <group title="">
        <x-input title="姓名" v-model="registerDto.userName" placeholder="请输入姓名" :min="1" :max="32" required></x-input>
        ...
        <x-input title="单位" v-model="registerDto.hospital" placeholder="请输入单位" :min="1" :max="32"  required></x-input>
        <x-input title="科室"  v-model="registerDto.department" placeholder="请输入科室" :min="1" :max="32"  required></x-input>
